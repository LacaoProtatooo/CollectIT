...
<body>
    ...
    <div class="mt-4 mb-4">
        <form action="{{route('collectible.store')}}" method="POST" enctype="multipart/form-data" class="max-w-md mx-auto ">
        @csrf
            <!-- Name -->
            ...
            <!-- Dimension -->
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="dimension" id="dimension" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
            ...
            <!-- Condition -->
            <div class="relative z-0 w-full mb-5 group">
                <input type="text" name="condition" id="condition" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
