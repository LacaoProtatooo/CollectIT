        ...
        <div class="card-body">
            ...
            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                <form class="space-y-6" action="#" method="POST">
                    ...
                    <div>
                        <label for="username" class="block text-sm font-medium leading-6 text-primary">Username</label>
                        <div class="mt-2">
                    ...
                    <div class="grid grid-cols-2 gap-x-4">
                        <div>
                            <label for="first_name" class="block text-sm font-medium leading-6 text-primary">First Name</label>
                            <div class="mt-2">
                        ...
                        <div>
                            <label for="last_name" class="block text-sm font-medium leading-6 text-primary">Last Name</label>
                            <div class="mt-2">
                    ...
                    <div>
                        <label for="confirm_password" class="block text-sm font-medium leading-6 text-primary">Confirm Password</label>
                        <div class="mt-2">
