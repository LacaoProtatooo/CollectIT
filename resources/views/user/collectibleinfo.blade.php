    ...
    <form method = "POST" action = "{{ route('cart.create') }}">
        ...
        <div class="items-center justify-center relative mb-5">
            ...
            <div class="flex items-center mb-2">
                ...
                <input type="number" name="quantity" id="quantity" min="1" value = "1" max= "{{$collectible->stock}}" class="text-black bg-white border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-transparent px-4 py-2">
